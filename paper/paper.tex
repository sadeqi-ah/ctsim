...
loss, at scale, or on large-diameter topologies the loss of decisions
itself dominates, with the commit rate dropping to 23.2\,\% in the largest
scalability network and 0.2\,\% for 2PC on the line topology. The cumulative progress view then shows that the
