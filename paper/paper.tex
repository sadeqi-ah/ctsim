...
counts airtime, interface spacing and guard bands, and excludes MCU
wake-up, radio ramp-up, local packet processing, turnaround beyond
$T_{\mathrm{IFS}}$, and repeated transmissions within a flood. Published
