...
the commit rate stays close to complete for most combinations, though it
drops to 23.2\,\% in the largest scalability network and 0.2\,\% for 2PC
on the line topology. The cumulative progress view then shows that the
